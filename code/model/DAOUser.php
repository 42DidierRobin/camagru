<?php
	...
	class DAOUser
	{
		...
		public
		static function newUser($login, $password, $email)
		{
			//TODO: verefier que cette chaine randome dexiste pas deja
			$activation = self::random_str(42);
			$statement = PDOS::getInstance()->prepare("INSERT INTO users (login, email, password, activation) VAlUE (:login, :email, :password, :activation)");
			$statement->bindValue(':login', $login);
